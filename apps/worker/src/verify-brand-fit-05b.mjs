...
const candidate = {
  ...
  id: "candidate-05b",
  workspaceId: baseWorkspace.id,
  title: "Mobile puzzle mastery grows among Vietnam players",
  summary: "Cross-source discussion around mobile puzzle play and player mastery.",
  status: "candidate",
  ...
  resolutionAnchors: ["mobile puzzle", "players", "Vietnam"],
  geographies: ["Vietnam"],
  languages: ["vi", "en"],
